...
const BagPage = () => {
  ...
  return (
    <section>
      <div class="container w-full mt-5 pt-3 pb-10 mx-auto">
        {res.length === 0 ? (
          <div class="inner_content mx-auto flex flex-col items-center my-20">
            <img class="w-32" src="/public/shopocat.png" alt="" />
          ...
          <>
            <div class="bg-[#f2f4f7] px-4 py-3 block lg:hidden rounded-xl">
              <div class="flex">
              ...
              <div class="flex gap-1 mt-3">
                <div class="w-[28%] flex flex-col items-end gap-2">
                  <div class="green_line bg-[#00ad3a] h-1 rounded w-full"></div>
                  <p class="flex items-center text-[#00ad3a] gap-1 text-xs">
                    20 000 сум
                    <svg
                      width="14"
                      height="14"
                ...
                <div class="w-[72%] flex flex-col items-end gap-2">
                  <div class="green_line bg-[#00ad3a] h-1 rounded w-full"></div>
                  <p class="flex items-center text-[#00ad3a] gap-1 text-xs">
                    1 000 000 сум
                    <svg
            ...
            <div class="prod_container w-full mt-5 pt-3 pb-10 mx-auto">
              <h1 class="text-2xl mb-6">
                Ваша корзина,
                <span class="prod_num opacity-70 font-semibold"></span>
              </h1>
              <div class="inner_container w-full flex flex-col xl:flex-row gap-4">
                <div class="content w-[75%] border rounded border-gray-300 py-3 px-4">
                  <div class="flex flex-col sm:flex-row justify-between sm:items-center pb-3">
                    <div class="flex gap-2 items-center">
                      <input type="checkbox" />
                      <p>Снять все</p>
                    </div>
                    <div>
                      <div class="text-sm bg-[#f2f4f7] sm:bg-white w-full sm:w-fit py-1 sm:py-0 rounded-xl sm:px-0 flex flex-col sm:flex-row items-center sm:gap-2">
                        <p class="opacity-70">Ближайшая дата доставки:</p>
                        <span class="delivery_date sm:border border-[#7000ff] px-2 py-[1px] text-[#7000ff]">
                          Доставка {tomorrowDateFormat} (Завтра)
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div class="checkout lg:w-full sticky h-full top-3 right-0 xl:w-[25%] xl:flex flex-col justify-center gap-6">
                  <div class="border  rounded-lg px-4 py-3">
                    <h2 class="text-lg font-semibold opacity-90">Ваш заказ</h2>
                    <ul class="flex justify-between items-center mt-5">
                      <li class="opacity-90">
                        Товары <span class="prod_number">({res.length}):</span>
                      </li>
                      <li class="general_sum"></li>
                    </ul>
                    <div class="delivery_date my-3 border border-[#7000ff] px-2 py-[1px] text-[#7000ff] text-center text-sm rounded">
                      Доставка {tomorrowDateFormat} (Завтра)
                    </div>
                    <div class="flex justify-between items-start">
                      <p class="opacity-90">Итого</p>
                      <div class="flex flex-col items-end">
                        <p class="real_sum text-xl font-semibold"></p>
                        <p class="trash_sum text-[#009c38] text-sm">
                          Вы экономите: <span class="saved_money"></span>
                        </p>
                      </div>
                    </div>
                    <button class="checkout_btn hidden bg-[#7000ff] text-white xl:flex w-full text-lg mt-4 mb-2 font-semibold py-2 rounded-xl justify-center">
                      Перейти к оформлению
                    </button>
                  </div>
                  <div class="bg-[#f2f4f7] px-4 py-3 md:hidden lg:block rounded-xl">
                    <div class="flex">
                      <p class="font-semibold">
                        Бесплатно доставим в пункт выдачи или курьером
                      </p>
      ...
      <div class="order_div lg:hidden px-4 py-3 items-center fixed bottom-[54px] md:bottom-[76px] flex justify-between w-full bg-white">
        <div>
          <p class="text-sm">Ваш заказ</p>
          <h2 class="real_sum text-lg"></h2>
        </div>
        <button class="text-white rounded-xl bg-[#7000ff] px-4 h-fit py-2">
          Оформить
        </button>
      </div>
    </section>
