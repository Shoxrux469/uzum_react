...
const PersonalInfo = () => {
    const { surname, name, phone } = user; // Destructuring user properties
        ...
        <div className="flex border flex-col gap-6 rounded-lg px-6 py-3">
            ...
            <ul className="profile_info_ul flex flex-col lg:flex-row gap-4">
                <li>
                    ...
                    <input defaultValue={surname} className="profile_inp surname w-full lg:w-fit rounded-xl" type="text" name="" id="" />
                </li>
                <li>
                    <label className="mb-2">Имя *</label>
                    <input defaultValue={name} className="profile_inp name w-full lg:w-fit rounded-xl" type="text" />
                </li>
            </ul>
            ...
            <div>
                ...
                <input defaultValue={`+998 ${phone}`} className="profile_inp phone_num w-full lg:w-fit rounded-xl" type="text" />
            </div>

            <div className="flex gap-2">
                <input className="w-5 mt-1 h-5 border-2 rounded-[2px] border-gray-400" type="checkbox" name="" id="" />
